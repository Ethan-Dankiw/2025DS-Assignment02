...
public class HttpRequestParser {
	...
	public static Optional<HttpRequest> parseRequest(BufferedReader fromClient) {
		...
		List<String> requestLine = HttpRequestParser.parseRequestLine(fromClient);
		...
		Map<String, String> headers = HttpRequestParser.parseHeaders(fromClient);
		...
		try {
			...
			String body = HttpRequestParser.parseBody(fromClient, contentLength);
